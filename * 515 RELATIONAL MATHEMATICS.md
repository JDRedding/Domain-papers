...
| PED | Treats relations as weighted and multiplies weights. That is an algebra (fuzzy / probabilistic / residuated), but not purely Boolean relation algebra. |
