...
- They are the backbone of $\mathrm{PSL}(2,\mathbb{R})$ isometries and modern hyperbolic embeddings in machine learning.  
...
with the induced metric from Minkowski space. This model gives the cleanest distance formula via the Lorentzian inner product. This is the defining relation for the hyperboloid model.
