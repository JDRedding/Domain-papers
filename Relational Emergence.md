...
## Emergence 
a relational sense emphasizes that higher-level properties do not reside solely in individual parts but arise through interrelations. Examples include:
Biologic networks (ecosystems, gene regulatory networks)
Social structures (markets, norms, organizational hierarchies)

## Cognitive phenomena (consciousness, collective intelligence)
...
- [RDG-MFE-Q](https://github.com/JDRedding/RDG-MFE-Q) repo; [Choose point](https://x.com/JDRedding/status/2053839104526393796) JD Redding, @JDRedding
