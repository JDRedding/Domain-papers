...
These are the equations you will meet first in plant physiology, crop modelling, and forest ecology. If you need the expanded FvCB electron-transport equations, the Penman–Monteith transpiration formula, or Höfler / pressure–volume curve relations, say which set to expand.
